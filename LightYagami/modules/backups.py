...
import LightYagami.modules.sql.notes_sql as sql
from LightYagami import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from LightYagami.__main__ import DATA_IMPORT
...
# from LightYagami.modules.rules import get_rules
import LightYagami.modules.sql.rules_sql as rulessql

# from LightYagami.modules.sql import warns_sql as warnssql
import LightYagami.modules.sql.blacklist_sql as blacklistsql
from LightYagami.modules.sql import disable_sql as disabledsql

# from LightYagami.modules.sql import cust_filters_sql as filtersql
# import LightYagami.modules.sql.welcome_sql as welcsql
import LightYagami.modules.sql.locks_sql as locksql
from LightYagami.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Zer0Byte{}.backup".format(chat_id), "rb"),
